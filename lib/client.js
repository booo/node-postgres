...
var Client = function(config, Connection) {
  ...
  if(config.connection) {
    ...
    this.connectionParameters = this.connection.config;
  } else {
    this.connectionParameters = new ConnectionParameters(config);
    this.connection = new Connection(this.connectionParameters, config.stream);
  }
  ...
  con.once('readyForQuery', function() {
    ...
    con.on('copyOutResponse', function(msg) {
      if (self.activeQuery.stream  === undefined) {
        ...
        (new self.constructor(self.connectionParameters))
